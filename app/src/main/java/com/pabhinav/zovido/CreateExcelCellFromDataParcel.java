...
public class CreateExcelCellFromDataParcel {
    ...
    public Label[][] createExcel() throws Exception{
        ...
        Label[][] labels = new Label[8][dataParcelArrayList.size()+1];
        ...
        for(int i = 0; i<dataParcelArrayList.size()+1; i++){
                ...
                if(i == 0) {
                    ...
                    labels[5][i] = new Label(5,i, "User Type");
                    labels[6][i] = new Label(6,i, "Product Type");
                    labels[7][i] = new Label(7,i, "Call Remarks");
                    ...
                    labels[5][i] = new Label(5,i, dataParcelArrayList.get(i-1).getUserType());
                    labels[6][i] = new Label(6,i, dataParcelArrayList.get(i-1).getProductType());
                    labels[7][i] = new Label(7,i, dataParcelArrayList.get(i-1).getCallRemarks());
